    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        <a href="/chat" className="group block">
          <Card className="p-5 sm:p-6 h-full transition-all duration-300 hover:shadow-lg" style={{ boxShadow: '0 0 0 transparent' }}>
        ...
        <a href="/reading" className="group block">
          <Card className="p-5 sm:p-6 h-full transition-all duration-300 hover:shadow-lg" style={{ boxShadow: '0 0 0 transparent' }}>
        ...
        <a href="/vocabulary" className="group block">
          <Card className="p-5 sm:p-6 h-full transition-all duration-300 hover:shadow-lg" style={{ boxShadow: '0 0 0 transparent' }}>
